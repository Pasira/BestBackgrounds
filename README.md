...
[Presentación del proyecto en Prezi](https://prezi.com/view/97ZvdPt4KYIhroeaSw6w)

[Presentación del proyecto, versión extendida en formato PDF](/Presentacion%20Best%20Backgrounds.pdf)
...
La aplicación contiene fondos adaptados al formato del dispositivo móvil, **facilitando el manejo** y **obviando el trabajo de tener que ajustar la imagen**, para ahorrar a los usuarios que al descargalas, tengan que modificarlas para ponerlas en sus móviles.
...
BEST | BACKGROUNDS 
:------------: | :-------------: 
**IMG 1** <br> <img src="/Capturas%20de%20Pantalla%20App/img1.png" width="200"> | Mostrará un SplashScreen mientras se carga la aplicación	
...
Si no es la primera vez que entramos y nos hemos registrado con anterioridad, solamente deberemos seleccionar la cuenta de correo con la que deseamos acceder y la misma contraseña que introducimos en el **registro** (No la contraseña de la cuenta de correo) | **IMG 4** <br> <img src="/Capturas%20de%20Pantalla%20App/img4.png" width="450">	
**IMG 5** <br> <img src="/Capturas%20de%20Pantalla%20App/img5.png" width="450"> | Una vez Iniciada sesión, nos preguntará si _aceptamos o rechazamos_ los permisos para que la aplicación tenga acceso a los medios, fotos y archivos del dispositivo. <br><br> **IMPORTANTE:** _Si no se aceptan los permisos, no se podrán descargar los fondos de pantalla de la aplicación_.
Una vez, hayamos aceptado o rechazado los permisos (como se explica en la _IMG 5_) nos aparecerá un Toast en la parte inferior con la cuenta que hayamos accedido y la pantalla con las categorías que posee la aplicación. | **IMG 6** <br> <img src="/Capturas%20de%20Pantalla%20App/img6.png" width="450">
**IMG 7** <br> <img src="/Capturas%20de%20Pantalla%20App/img7.png" width="450"> | Una vez que desaparezca el Toast, podremos ver en la barra inferior que nos aparecen **3 botones**, los cuales 2 de ellos, serán implementados en actualizaciones futuras, siendo el botón _Subir_ el que nos redirige a la opción de subir nuestros propios fondos de pantallas (opción explicada en la _IMG 11_).
Si deslizamos hacia la izquierda o seleccionamos _Populares_ situada en la parte superior, nos aparecerán aquellos fondos que más visitas tengan. | **IMG 8** <br> <img src="/Capturas%20de%20Pantalla%20App/img8.png" width="450">
**IMG 9** <br> <img src="/Capturas%20de%20Pantalla%20App/img9.png" width="450"> | Si deslizamos nuevamente hacia la izquierda o seleccionamos _Recientes_ situada en la parte superior, en esta sección podremos ver los últimos fondos vistos, siendo el primero de ellos el último fondo seleccionado.
Cuando seleccionamos cualquier fondo, nos aparecerá la imagen, en color "dorado" el nombre de la categoría en la que se encuentra, una posible descripción, y **dos opciones:** _Descargar_ (icono que se encuentra en la parte izquierda) y _Establecer como fondo de pantalla_ (icono que se encuentra en la parte derecha)| **IMG 10** <br> <img src="/Capturas%20de%20Pantalla%20App/img10.png" width="450">
...
Firebase | Analytics 
:------------: | :-------------: 
<img src="/Capturas%20de%20Pantalla%20App/Parte%20Administrativa/Captura0.JPG" width="450px"> | Aquí podemos ver el panel general, en el que encontraremos los parámetros que nos proporcionan información acerca de nuestra aplicación como por ejemplo: <br>- Los eventos que seleccionan los usuarios. <br>- La audiencia que posee, con la que nos permite saber la fecha de creación de los usuarios. <br>- Podemos ver la media, del tiempo que pasan los usuarios utilizando la aplicación. <br>- Además podemos ver los usarios en tiempo real que utilizan nuestra app.
Podemos ver los usuarios activos durante períodos de un día, siete días y treinta días, trazados en el tiempo. Los valores resumidos a la derecha muestran la cantidad de usuarios activos en el último día del período especificado. | <img src="/Capturas%20de%20Pantalla%20App/Parte%20Administrativa/Captura1.JPG" width="450px">
<img src="/Capturas%20de%20Pantalla%20App/Parte%20Administrativa/Captura2.JPG" width="450px"> | Muestra la interacción diaria que tienen los usuarios, además de las pantallas en las que los usuarios permanecen más tiempo.
Nos muestra un valor combinado para todas las fuentes de ingresos. Incluye los ingresos estimados de AdMob. <br>Esto viene muy bien, para saber los ingresos que tenemos mediante nuestra aplicación. | <img src="/Capturas%20de%20Pantalla%20App/Parte%20Administrativa/Captura3.JPG" width="450px">
<img src="/Capturas%20de%20Pantalla%20App/Parte%20Administrativa/Captura4.JPG" width="450px"> | Podemos ver el porcentaje de usuarios que no han experimentado bloqueos en la aplicación. 
Algo interesante, es poder comprobar la ubicación en la que se encuentra nuestra principal audiencia. | <img src="/Capturas%20de%20Pantalla%20App/Parte%20Administrativa/Captura5.JPG" width="450px">
<img src="/Capturas%20de%20Pantalla%20App/Parte%20Administrativa/Captura6.JPG" width="450px"> | En esta última, podemos comprobar las plataformas en la que se instalan la aplicación, siendo en este caso el 100% Android, ya que está desarrollada exclusivamente para dicha plataforma.
